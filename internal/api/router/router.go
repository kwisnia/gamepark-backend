...
func Setup() *gin.Engine {
	...
	r.POST("/games/webhooks/create", games.GameWebhookCreateHandler)
	r.POST("/games/webhooks/update", games.GameWebhookUpdateHandler)
	r.POST("/games/webhooks/delete", games.GameWebhookDeleteHandler)
